...
class SolarPosition
{
	...
	public Eci FindPosition(DateTime dt)
	{
		double mjd = dt.ToJulian() - Globals.kEPOCH_JAN1_12H_1900;
		double year = 1900 + mjd / 365.25;
		/*const*/ double T = (mjd + Delta_ET(year) / Globals.kSECONDS_PER_DAY) / 36525.0;
		...
		/*const*/ double Lsa = Util.WrapTwoPI(L + C - Util.DegreesToRadians(0.00569 - 0.00479 * Math.Sin(O)));
	...
	private double Delta_ET(double year)
	{
